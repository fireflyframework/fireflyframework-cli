...
Manage framework-wide CalVer versions across all repositories. CalVer format: `YY.MM.PP` (e.g., `26.02.01`).
...
| `parent_version` | `26.02.01` | Parent POM CalVer version for archetypes |
