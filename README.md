...
Manage framework-wide CalVer versions across all repositories. CalVer format: `YY.MM.PP` (e.g., `26.02.02`).
...
| `parent_version` | `26.02.02` | Parent POM CalVer version for archetypes |
