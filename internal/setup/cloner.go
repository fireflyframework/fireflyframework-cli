...
var FrameworkRepos = []string{
	...
	"fireflyframework-cache-redis",
	"fireflyframework-cache-hazelcast",
	"fireflyframework-cache-jcache",
	"fireflyframework-cache-postgres",
	"fireflyframework-r2dbc",
	"fireflyframework-eda",
	"fireflyframework-eda-kafka",
	"fireflyframework-eda-rabbitmq",
	"fireflyframework-eda-postgres",
